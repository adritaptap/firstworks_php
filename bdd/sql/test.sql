...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 05 Décembre 2016 à 21:42
...
(38, 'Le Maillon Faible', 'Matt', 'PS2', 10, 1, 'Le jeu de l\'émission'),
...
(44, 'F-ZERO', 'Matt', 'GBA', 25, 4, 'Un super jeu de course futuriste !'),
(45, 'Harry Potter Et La Chambre Des Secrets', 'Matt', 'Xbox', 30, 1, 'Abracadabra !! Le célebre magicien est de retour !'),
...
(52, 'Battlefield 1942', 'Patrick', 'PC', 10, 32, '2nde guerre mondiale'),
(53, 'Tomb raider', 'Adrien', 'Playstation', 20, 1, 'Mon tout premier jeux de playstation');
...
INSERT INTO `messagerie` (`ID`, `pseudo`, `message`, `date_creation`) VALUES
(1, 'adri', 'Hello World !', '2016-12-04 20:02:05'),
(2, 'anna', 'Salut Adri.', '2016-12-04 20:02:05'),
(3, 'Barnabé', 'Wesh', '2016-12-04 20:02:05'),
(4, 'adri', '&lt;strong&gt;Vous allez bien ?&lt;/strong&gt;', '2016-12-04 20:02:05'),
(5, 'anna', 'Ca va bien et toi ?', '2016-12-04 20:02:05'),
(6, 'Michel', 'Salut à tous', '2016-12-04 20:02:05'),
(7, 'Michel', 'Vous parlez de quoi ?', '2016-12-04 20:02:05'),
(8, 'adri', 'On parle de tout et de rien', '2016-12-04 20:02:05'),
(9, 'adri', 'Test pour l\'heure', '2016-12-04 21:05:39'),
(10, 'anna', 'Ca marche', '2016-12-04 21:05:49'),
(11, 'adrien', 'test sur la nouvelle page', '2016-12-04 22:35:27'),
(12, 'Adrien', 'Salut à tous, Je veux vous parler de php et des bases de données', '2016-12-04 23:34:48');
...
INSERT INTO `visiteur` (`id`, `pseudo`, `age`, `email`) VALUES
(1, 'Adrien', 28, 'adrien.juhem@gmail.com'),
(2, 'Robert', 35, 'robert.exemple.com');
